...
dataset_dir = "/mnt/c/Users/86183/Desktop/MyDataset"
data_name = 'MyDataset'  # 模型名称,仅在保存的时候用到
#vocab_path = 'data/MyDataset/vocab.txt'
vocab_path = '/mnt/c/Users/86183/Desktop/MyDataset/vocab.txt'
train_set_path = './data/small/train.json'
val_set_path = './data/small/val.json'
testset_dir='/mnt/c/Users/86183/Desktop/MyDataset_test'
